...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let btnbg = ColorAsset(name: "btnbg")
    internal static let plusbg = ColorAsset(name: "plusbg")
    internal static let red = ColorAsset(name: "red")
    internal static let subtitle = ColorAsset(name: "subtitle")
    internal static let time = ColorAsset(name: "time")
    internal static let title = ColorAsset(name: "title")
    internal static let txtTitleLabel = ColorAsset(name: "txt_title_label")
